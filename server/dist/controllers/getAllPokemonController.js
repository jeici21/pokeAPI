...
function getAllPokemonController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { rows } = yield __1.pool.query(`
            SELECT Pokemon.id, Pokemon.nombre, Pokemon.descripcion, Tipo.img as tipo1, Tipo2.img as tipo2, Pokemon.evolucion, Pokemon.altura, Pokemon.peso, Pokemon.img
